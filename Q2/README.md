...
1. Which real-time approach did you choose and why? What are the trade-offs you considered?
   ...
   A: websocket, compared to another codes seems more popular and plenty of libraries. given that there are no show-stopper for the websocket i will choose websocket
   ![](./_doc/ws_vs_sse.png)
